...
def download_and_clean(
    ...
    if os.path.exists(test_if_exist):
        ...
        print("Downloading elwood v{}...".format(version), file=sys.stderr)
        ...
        with open(vpath, "w") as vfile:
            vfile.write("elwood-{}".format(version))

        print("Downloaded elwood v{} to {}".format(version, outdir), file=sys.stderr)
